...
function [DeepMIMO_dataset,params]=DeepMIMO_Dataset_Generator_RA(number_of_path, n_bs, active_user_first, active_user_last)
...
params.active_BS=1:n_bs;          % Includes the numbers of the active BSs (values from 1-18 for 'O1')

% Active users
params.active_user_first=active_user_first;       % The first row of the considered receivers section (check the scenario description for the receiver row map)
params.active_user_last=active_user_last;        % The last row of the considered receivers section (check the scenario description for the receiver row map)
...
% Number of paths
params.num_paths=number_of_path;                  % Maximum number of paths to be considered (a value between 1 and 25), e.g., choose 1 if you are only interested in the strongest path
